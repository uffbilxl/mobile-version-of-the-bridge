...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-card-border bg-card/85 backdrop-blur">
      ...
      {/* Mobile menu — full-screen sheet anchored to the viewport */}
      <div
        id="mobile-menu"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        {/* Panel */}
        <div
          className={`relative flex h-full w-full flex-col bg-background transition-transform duration-200 ease-out ${
