...
export const MENTORS: Mentor[] = [
  { id: "m1", name: "Amara K.", initials: "AK", role: "Software Engineer", company: "Google", category: "Engineering", skill_tags: ["Python", "Computer Vision", "Career"], availability: "Available today", story: "Grew up in south London, taught myself Python at 19. Now I write ML pipelines at Google.", bio: "I help people break into engineering without a CS degree. We'll talk about projects, interviews, and what to actually study.", color: "#00E5A0" },
  { id: "m2", name: "Joel S.", initials: "JS", role: "UX Designer", company: "BBC", category: "Design", skill_tags: ["Figma", "Portfolio"], availability: "Available today", story: "I went from making memes for fun to designing news products watched by millions.", bio: "Portfolio reviews, Figma tips, and how to land your first design job without going to art school.", color: "#FFA657" },
  { id: "m3", name: "Priya M.", initials: "PM", role: "Product Manager", company: "Monzo", category: "Product", skill_tags: ["Product thinking", "Interviews"], availability: "This week", story: "Came into product from a customer support role. No MBA. Just curiosity and lots of asking.", bio: "How product actually works, how to talk about your ideas, and how to interview without panicking.", color: "#378ADD" },
  { id: "m4", name: "Darius T.", initials: "DT", role: "Data Scientist", company: "NHS Digital", category: "AI", skill_tags: ["Python", "AI", "Data"], availability: "3 slots left", story: "I work on data that helps real patients. Came from a sociology degree, learnt Python on YouTube.", bio: "Getting into data and AI. We'll figure out what to learn, in what order, and where to practise.", color: "#AFA9EC" },
  { id: "m5", name: "Lena N.", initials: "LN", role: "Frontend Dev", company: "Spotify", category: "Engineering", skill_tags: ["React", "CSS", "Web"], availability: "Available today", story: "First job was at a print shop. Now I build the Spotify web player. The internet is wild.", bio: "React, CSS, and what a real frontend role actually looks like day to day.", color: "#00E5A0" },
  { id: "m6", name: "Olumide A.", initials: "OA", role: "Community Mentor", company: "Centauri", category: "Career advice", skill_tags: ["Confidence", "Goals"], availability: "Walk-in available", story: "I've mentored 200+ young people. My job is to help you figure out what you actually want.", bio: "Not sure what direction to go in? Start here. No tech jargon, just a real conversation.", color: "#FFA657" },
  { id: "m7", name: "Sarah C.", initials: "SC", role: "DevOps Engineer", company: "ASOS", category: "Engineering", skill_tags: ["Cloud", "Linux", "Career"], availability: "This week", story: "Apprenticeship route. No university. Now I run cloud infrastructure for ASOS.", bio: "Apprenticeships, cloud basics, and a different way into engineering.", color: "#378ADD" },
  { id: "m8", name: "Marcus W.", initials: "MW", role: "Founder", company: "YC startup", category: "Career advice", skill_tags: ["Entrepreneurship", "Funding"], availability: "This week", story: "Built my first product on my mum's old laptop. Got into YC three years later.", bio: "Building something? Let's talk. Ideas, first users, and what to do when you have no money.", color: "#AFA9EC" },
];
